...
<head>
    ...
    <!-- Подключение Tailwind CSS через CDN для автономной работы -->
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        /* Основной шрифт и стили для интерфейса */
        body {
        ...
        /* Стили для кнопки чата поддержки */
        #supportChatButton {
            position: fixed;
            bottom: 20px;
            right: 20px;
...
<body class="bg-gray-100 text-gray-900">
    ...
    <div class="container mx-auto p-6">
        ...
        <section id="appeals" class="tab-content">
            ...
            <!-- Модальное окно для деталей обращения -->
    ...
    <script>
        ...
        // Переключение модального окна чата поддержки
        ...
        // Имитация отправки сообщения в поддержку
        ...
        // Имитация сохранения сотрудника
        ...
        // Имитация сохранения экстренного контакта
        ...
        // Обработка модального окна обращения
        ...
        // Имитация ИИ-помощника
        document.getElementById('askAI').addEventListener('click', () => {
            const question = document.getElementById('aiQuestion').value;
            const aiResponse = document.getElementById('aiResponse');
            if (question) {
                // Имитация ответа ИИ (в реальной версии использовать API, например, OpenAI)
                const mockResponses = {
